# Fan Button Row
Original repo - fan-percent-button-row: Provides a means to program 2 or 3 preset speed percentage settings for fans selectable from a Lovelace button row.
Addition: fan-state-button-row: Provides a means to program 3-state preset mode fans
